    ...
    <nav className="navbar navbar-expand-lg navbar-light p-0">
      <div className="navbar-left">
        <ul id="topbar-data-icon" className="d-flex p-0 topbar-menu-icon">
          ...
          <li><a href="index.html" className="nav-link"><i className="ri-inbox-line" /></a></li>
        </ul>
          ...
          <form action="#" className="searchbox">
            ...
            <div className="searchbox-datalink">
              ...
              <ul className="m-0 pl-3 pr-3 pb-3">
                ...
                <li className="iq-bg-primary-hover rounded"><a href="index.html" className="nav-link"><i className="ri-mail-line pr-2" />Email</a></li>
      ...
      <div className="collapse navbar-collapse" id="navbarSupportedContent">
        <ul className="navbar-nav ml-auto navbar-list">
          <li className="nav-item">
            <a className="search-toggle iq-waves-effect language-title" href="#"><img src="../images/small/flag-01.png" alt="img-flaf" className="img-fluid mr-1" style={{height: 16, width: 16}} /> English <i className="ri-arrow-down-s-line" /></a>
            ...
            <div className="iq-card shadow-none m-0">
              <div className="iq-card-body p-0 ">
                ...
                <div className="d-inline-block w-100 text-center p-3">
                  <a className="btn btn-primary dark-btn-primary" href="sign-in.html" role="button">Sign out<i className="ri-login-box-line ml-2" /></a>
                </div>
              </div>
            </div>
          </div>
